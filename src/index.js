...
document.getElementById("message1").innerHTML = cipher.encode(resultEncrypt, resultEncrypt1); 
});
...
document.getElementById("message2").innerHTML = "" + cipher.encode(resultEncrypt2, resultEncrypt3); 
});
